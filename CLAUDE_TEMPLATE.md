...
git init
git config --local user.name "Su-Jhen"
git config --local user.email "sjhung0726@gmail.com"
...
git init && git config --local user.name "Su-Jhen" && git config --local user.email "sjhung0726@gmail.com"
